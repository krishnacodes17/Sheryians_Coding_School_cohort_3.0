...
let arr = ["krishna", 5, true]; // ? issme ham fixed sizedege naa jayada element desakte hainaa kam  aur innka types bhisemehona chaiye number hai too 5 agar number wali jagh pe "krishna" string diya wrong hai
