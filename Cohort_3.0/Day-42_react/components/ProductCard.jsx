...
function ProductCard({ product }) {
  ...
  const {setCartProduct ,cartProduct} = useContext(DataContext)
...
// console.log(cartProduct)
  return (
    <div className="w-80 rounded-xl shadow-lg overflow-hidden border hover:shadow-2xl transition duration-300">
      ...
      {/* Product Image */}
      <div className="h-64 bg-white flex items-center justify-center p-5">
        <img
          src={product.image}
          alt={product.title}
      ...
      <div className="p-4 space-y-3">
        ...
        <button 
        onClick={()=> setCartProduct((prev)=> [...prev , product])}
